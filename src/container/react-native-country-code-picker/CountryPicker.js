            ...
            <Modal visible={this.state.isShow} animationType={this.props.animationType || 'slide'} transparent={false}>
                <View style={styles.container}>
                    <View style={[styles.container1]}>
                        ...
                        />
                        <TouchableHighlight onPress={() => this.setState({isShow: false})}>
                    ...
                    <View style={[styles.container2]}>
                        <SectionList
                            ...
                            renderItem={({item, index}) => (this.state.matchItem.has(item.countryCode) || this.state.fullList) ? <TouchableHighlight onPress={() => this.phoneCodeSelected(item)} key={index}><View style={[styles.sessionListItemContainer]} ><Text style={[styles.sessionListItem1]}>{item.countryName}</Text><Text style={[styles.sessionListItem2]}>+{item.phoneCode}</Text></View></TouchableHighlight>: <View></View>}
